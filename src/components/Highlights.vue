...
<template>
  <div class="section highlights">
    <div class="title">Погода сейчас</div>
    <div class="highlights-wrapper">
          ...
          <div class="card-info">
            <div class="card-justify">
              ...
              <div class="info-main">
                ...
                <div class="info-main-text">градусов</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="highlight">
        ...
        <div class="card-small">
          <div class="card-small-title">Ощущается как</div>
          <div class="card-small-info">
            ...
            <div class="card-small-hint">
              ...
              <div class="card-small-text">
                Насколько жарко или холодно это на самом деле
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            ...
            <div class="card-small-hint">
              ...
              <div class="card-small-text">Часть неба была скрыта облаками</div>
            </div>
          </div>
        </div>
      </div>
